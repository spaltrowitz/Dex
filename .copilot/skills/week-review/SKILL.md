...
> Interested? Run "dex improve" to workshop any of these.
...
**Then:** Run "update identity snapshot" to update `System/identity-model.md` with fresh data from this week.
...
4. Offer to run "plan my week" for next week
