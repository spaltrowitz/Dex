...
description: Process synced WorkIQ meetings to update person pages, extract tasks, and organize meeting notes
---
# Process Meetings

Process meetings that have been synced from WorkIQ by the background automation. Updates person pages, extracts tasks, and organizes meeting notes.
...
>
> **Requirements:**
> - WorkIQ configured ([WorkIQ](https://WorkIQ))
...
1. Read frontmatter to get `WorkIQ_id`, `participants`, `company`, `date`
...
> 1. WorkIQ is available during your meetings
