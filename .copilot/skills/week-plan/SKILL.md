...
- "plan my week" — Plan current week (or next week if run on Friday/weekend)
- "plan next week" — Explicitly plan next week
...
> 
> Ready to run "plan my day" for Monday?"
...
| WorkIQ | WorkIQ (ask_work_iq) | `ask_work_iq` (optional) |
