...
**Examples:**
- "career coaching session" — Start fresh session
...
During "end of day review", if user mentions career-relevant achievements:
...
During "review my quarter", prompt:

```markdown
## Career Check-in

It's been a quarter. Want to run "career coaching session" and do a promotion assessment or monthly reflection?
...
**Use "career coaching session" when:**
...
**Don't use it for:**
- Day-to-day task management (use "plan my day")
- Project status updates (use "check project health")
- Meeting prep (use "prep for meeting")
