...
- "review my quarter" — Review current/recently ended quarter
...
2. **If `false`:**
   - Display: "Quarterly planning is disabled. Enable it first with "plan my quarter""
   - End command
...
**If yes:** Flow directly into "plan next quarter"
...
3. Suggest running "plan my quarter" for next quarter
